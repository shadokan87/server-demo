...
export const streamChunkToMessage = (chunk, message = {}) => {
...
export const isSkipEvent = (data) => {
    return typeof data == "object" && data[SKIP_EVENT] == true;
};
export const skipEventFallback = (data, fallback) => {
    if (isSkipEvent(data))
        return fallback;
    return data;
};
